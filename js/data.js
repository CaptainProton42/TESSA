...
Venus = new StellarBody(
    name = "Venus",
    elements = new Elements(
        nu = 4.990452231866427E+01 * DEG_TO_RAD,
...
Earth = new StellarBody(
    name = "Earth",
    elements = new Elements(
        nu= 3.581260865454548E+02 * DEG_TO_RAD,
...
Mars = new StellarBody(
    name = "Mars",
    elements = new Elements(
        nu = 2.302024685336155E+01 * DEG_TO_RAD,
...
Jupiter = new StellarBody(
    name = "Jupiter",
    elements = new Elements(
        nu = 2.063463725846524E+01 * DEG_TO_RAD,
...
Saturn = new StellarBody(
    name = "Saturn",
    elements = new Elements(
        nu = 4.335467468895084E+03 * DEG_TO_RAD,
...
Uranus = new StellarBody(
    name = "Uranus",
    elements = new Elements(
        nu = 1.458440916327605E+02 * DEG_TO_RAD,
...
Neptune = new StellarBody(
    name = "Neptune",
    elements = new Elements(
        nu = 2.653308418993787E+02 * DEG_TO_RAD,
...
Ceres = new StellarBody(
    name = "Ceres",
    elements = new Elements(
        nu = 7.121190541431409E+00 * DEG_TO_RAD,
