...
Mercury = new StellarBody(
    ...
    elements = new Elements(
        M = 1.072381116824175E-04 * DEG_TO_RAD,
        a = 3.870982252717257E-01,
        e = 2.056302512089075E-01,
        i = 7.005014199657344E+00 * DEG_TO_RAD,
        w = 2.912449851122127E+01 * DEG_TO_RAD,
        Om = 4.833053756455964E+01 * DEG_TO_RAD,
...
Venus = new StellarBody(
    ...
    elements = new Elements(
        ...
        w = 5.515060616399271E+01 * DEG_TO_RAD,
...
Earth = new StellarBody(
    ...
    elements = new Elements(
        ...
        w = 3.466842291877282E+02 * DEG_TO_RAD,
...
Mars = new StellarBody(
    ...
    elements = new Elements(
        ...
        w = 2.865365925491049E+02 * DEG_TO_RAD,
...
Jupiter = new StellarBody(
    ...
    elements = new Elements(
        ...
        w = 2.751062202056233E+02 * DEG_TO_RAD,
...
Saturn = new StellarBody(
    ...
    elements = new Elements(
        ...
        w = 3.400788119123579E+02 * DEG_TO_RAD,
...
Uranus = new StellarBody(
    ...
    elements = new Elements(
        ...
        w = 9.498660073711042E+01 * DEG_TO_RAD,
...
Neptune = new StellarBody(
    ...
    elements = new Elements(
        ...
        w = 2.661278046724627E+02 * DEG_TO_RAD,
...
Ceres = new StellarBody(
    ...
    elements = new Elements(
        ...
        w = 7.391891192633561E+01 * DEG_TO_RAD,
        Om = 8.049436516467529E+01 * DEG_TO_RAD,
